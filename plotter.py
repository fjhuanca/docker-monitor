...
class Plotter:
    ...
    def plot(self, filename):
        ...
        plt.plot(self.times, moving_average(self.cpu, 10), linewidth=2, color="red", label="Rolling mean (10s)", linestyle='dashed')
        ...
        plt.plot(self.times, moving_average(self.mem, 10), linewidth=2, color="red", label="Rolling mean (10s)", linestyle='dashed')
        plt.xlabel("Time [s]/[date]")
        plt.ylabel("RAM [MB]")
        plt.title("Mem Usage")
        plt.legend()
